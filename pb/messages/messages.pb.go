...
func (m *Pages) GetDocumentId() uint32 {
	if m != nil {
		return m.DocumentId
	}
	return 0
...
var fileDescriptor_83994550f81e9f35 = []byte{
	...
	,
}
...
func (m *Pages) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DocumentId != 0 {
		i = encodeVarintMessages(dAtA, i, uint64(m.DocumentId))
		i--
		dAtA[i] = 0x8
	}
...
func (m *Pages) Size() (n int) {
	...
	_ = l
	if m.DocumentId != 0 {
		n += 1 + sovMessages(uint64(m.DocumentId))
	}
	l = len(m.Data)
	if l > 0 {
