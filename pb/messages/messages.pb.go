...
func (m *Pages) GetChapterId() uint32 {
	if m != nil {
		return m.ChapterId
	}
	return 0
...
var fileDescriptor_83994550f81e9f35 = []byte{
	...
	,
}
...
func (m *Pages) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ChapterId != 0 {
		i = encodeVarintMessages(dAtA, i, uint64(m.ChapterId))
		i--
		dAtA[i] = 0x8
	}
...
func (m *Pages) Size() (n int) {
	...
	_ = l
	if m.ChapterId != 0 {
		n += 1 + sovMessages(uint64(m.ChapterId))
	}
	l = len(m.Data)
	if l > 0 {
