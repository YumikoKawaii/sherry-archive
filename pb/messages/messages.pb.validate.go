...
// ValidateAll checks the field values on Pages with the rules defined in the
// proto definition for this message. If any rules are violated, the result is
// a list of violation errors wrapped in PagesMultiError, or nil if none found.
func (m *Pages) ValidateAll() error {
	return m.validate(true)
}

func (m *Pages) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return PagesMultiError(errors)
	}

	return nil
}

// PagesMultiError is an error wrapping multiple validation errors returned by
// Pages.ValidateAll() if the designated constraints aren't met.
type PagesMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m PagesMultiError) Error() string {
...
func (m PagesMultiError) AllErrors() []error { return m }
