...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.PagedMangaResponse"
                        }
                    }
                }
            },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateMangaRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateMangaRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ChapterWithPagesResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.PagedCommentResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ReorderPagesRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/mangas/{mangaID}/comments/{commentID}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpsertBookmarkRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.ChapterWithPagesResponse": {
            ...
            "properties": {
                ...
                "pages": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.PageItemResponse"
                    }
                }
            }
        },
        ...
        "dto.CommentResponse": {
            ...
            "properties": {
                "author": {
                    "$ref": "#/definitions/dto.CommentAuthor"
                },
                "content": {
                    "type": "string"
                },
        ...
        "dto.CreateMangaRequest": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/model.MangaStatus"
                },
                "tags": {
                    "type": "array",
                    "items": {
                ...
                "type": {
                    "$ref": "#/definitions/model.MangaType"
                }
            }
        },
        "dto.ErrorResponse": {
